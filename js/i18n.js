...
const I18N = {
  ru: {
    ...
    'sell.titleHint': 'Уточните модель и детали', 'sell.byAI': 'оценка Gemini по фото',
    'sell.geminiRecognizing': 'Gemini распознаёт товар…', 'sell.geminiFail': 'Gemini недоступен — использую базовое распознавание',
    'sell.geminiTitle': 'Точное распознавание (Gemini)', 'sell.geminiSub': 'Определяет бренд, модель, пишет описание и цену',
    'sell.geminiOn': 'Gemini подключён — распознаёт точно', 'sell.geminiOff': 'Отключить',
    'sell.geminiModalTitle': 'Подключить Gemini', 'sell.geminiKeyPh': 'Вставьте API-ключ Google',
    'sell.geminiHow': 'Получите бесплатный ключ Google AI Studio и вставьте сюда. Ключ хранится только в вашем браузере, фото уходит напрямую в Google.',
    'sell.geminiGetKey': 'Получить бесплатный ключ', 'sell.geminiSave': 'Подключить',
    'sell.geminiConnected': 'Gemini подключён 🔮', 'sell.geminiDisconnected': 'Gemini отключён',
  ...
  en: {
    ...
    'sell.titleHint': 'Add the model and details', 'sell.byAI': 'Gemini estimate from the photo',
    'sell.geminiRecognizing': 'Gemini is recognizing the item…', 'sell.geminiFail': 'Gemini unavailable — using basic recognition',
    'sell.geminiTitle': 'Precise recognition (Gemini)', 'sell.geminiSub': 'Detects brand, model, writes the description and price',
    'sell.geminiOn': 'Gemini connected — precise recognition', 'sell.geminiOff': 'Disconnect',
    'sell.geminiModalTitle': 'Connect Gemini', 'sell.geminiKeyPh': 'Paste your Google API key',
    'sell.geminiHow': 'Get a free Google AI Studio key and paste it here. The key stays only in your browser; the photo goes directly to Google.',
    'sell.geminiGetKey': 'Get a free key', 'sell.geminiSave': 'Connect',
    'sell.geminiConnected': 'Gemini connected 🔮', 'sell.geminiDisconnected': 'Gemini disconnected',
  ...
  ky: {
    ...
    'sell.titleHint': 'Моделди жана деталдарды кошуңуз', 'sell.byAI': 'Gemini сүрөт боюнча баасы',
    'sell.geminiRecognizing': 'Gemini товарды таанып жатат…', 'sell.geminiFail': 'Gemini жеткиликсиз — негизги таанууну колдоном',
    'sell.geminiTitle': 'Так таануу (Gemini)', 'sell.geminiSub': 'Бренд, модель аныктайт, сүрөттөмө жана баа жазат',
    'sell.geminiOn': 'Gemini туташты — так таанийт', 'sell.geminiOff': 'Өчүрүү',
    'sell.geminiModalTitle': 'Gemini туташтыруу', 'sell.geminiKeyPh': 'Google API ачкычын коюңуз',
    'sell.geminiHow': 'Google AI Studio акысыз ачкычын алып, бул жерге коюңуз. Ачкыч браузериңизде гана сакталат, сүрөт түз Google’га кетет.',
    'sell.geminiGetKey': 'Акысыз ачкыч алуу', 'sell.geminiSave': 'Туташтыруу',
    'sell.geminiConnected': 'Gemini туташты 🔮', 'sell.geminiDisconnected': 'Gemini өчүрүлдү',
