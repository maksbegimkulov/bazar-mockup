...
const I18N = {
  ru: {
    ...
    'ai.banner.title': 'Диана — ИИ-помощница', 'ai.banner.sub': 'Опишите словами, что ищете: «макбук до 100к б/у» — найду за секунду', 'ai.banner.btn': 'Спросить',
  ...
  en: {
    ...
    'ai.banner.title': 'Diana — AI assistant', 'ai.banner.sub': 'Describe what you need: “macbook under 100k” — I’ll find it in a second', 'ai.banner.btn': 'Ask',
  ...
  ky: {
    ...
    'ai.banner.title': 'Диана — AI жардамчы', 'ai.banner.sub': 'Эмне издеп жатканыңызды жазыңыз: «макбук 100к чейин» — заматта табам', 'ai.banner.btn': 'Суроо',
